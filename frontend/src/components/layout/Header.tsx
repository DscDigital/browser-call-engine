      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Global header placeholder</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="rounded-full bg-slate-100 px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-200">
            User
          </button>
        </div>
      </div>
